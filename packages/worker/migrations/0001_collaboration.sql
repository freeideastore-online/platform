...
INSERT OR IGNORE INTO ideas (id, title, summary, stage, category, next_step, risk, created_by, pro_candidate) VALUES
  ...
  ('school-transport-options', 'School Transport Options', 'Parents need safer, clearer transport options for ages 5-10.', 'researched', 'local-services', 'Interview 15 parents and 5 school administrators about trust and logistics.', 'Trust, liability, regulation, and operations are hard.', 'profile-system', 0),
  ...
  ('idea-reputation-system', 'Idea Reputation System', 'People can earn recognition by improving ideas, not just building apps.', 'prototype', 'platform', 'Define badges and contribution events that cannot be gamed easily.', 'Low-quality AI-generated comments could flood the system.', 'profile-system', 1),
  ('proidea-dossier-builder', 'ProIdea Dossier Builder', 'The valuable artifact may be a complete opportunity packet, not the idea itself.', 'prototype', 'platform', 'Create one dossier manually and see if builders or investors ask for more.', 'Research quality must be high enough to justify curation.', 'profile-system', 1);
