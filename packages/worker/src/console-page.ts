...
header{position:sticky;top:0;z-index:10;display:flex;align-items:center;gap:1rem;border-bottom:1px solid var(--line);background:var(--topbar-bg);padding:.7rem 1.25rem;backdrop-filter:blur(14px)}.brand{display:flex;align-items:center;gap:.6rem;font-weight:800;margin-right:auto}.mark{display:grid;height:34px;width:34px;place-items:center;border-radius:8px;background:#102027;color:#67e8f9;font-weight:900}.brand span:last-child{font-family:Fraunces,serif}nav{display:flex;align-items:center;gap:.9rem;color:var(--muted);font-size:.8rem;font-weight:800}.account-avatar{display:inline-grid;width:36px;height:36px;place-items:center;border:2px solid var(--line);border-radius:50%;overflow:hidden;background:var(--panel)}#account-slot{display:flex;align-items:center;color:var(--muted);font-size:.8rem;font-weight:800}.account-avatar img{width:100%;height:100%;object-fit:cover}.account-avatar span{display:grid;width:100%;height:100%;place-items:center;border-radius:50%;background:#102027;color:#67e8f9;font-weight:900}
...
@media(max-width:840px){.layout{grid-template-columns:1fr}.split{grid-template-columns:1fr}.panel-head{align-items:flex-start;flex-direction:column}.work-toolbar{width:100%;justify-content:space-between}}
${navCss(840)}
</style>
</head>
<body>
